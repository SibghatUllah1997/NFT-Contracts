...
// File: contracts/ChimeraTokenCreatorRegistry.sol
 ...
 * @title IERC721 Non-Fungible Token Creator basic interface
 */
contract ChimeraTokenCreatorRegistery is Initializable, OwnableUpgradeable, IERC721TokenCreator {
     ...
     * @param _iERC721Creators address[] to set as iERC721Creators.
     */
     function InitializeChimeraTokenCreatorRegistery(address[] memory _iERC721Creators) public initializer {
        require(
            _iERC721Creators.length < 1000,
            "constructor::Cannot mark more than 1000 addresses as IERC721Creator"
        );
