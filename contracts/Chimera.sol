...
contract Chimera is Initializable, ERC721Upgradeable, OwnableUpgradeable, Whitelist {
    ...
    function InitializeChimera(string memory name, string memory symbol)  public initializer {
    ...
    function deleteToken(uint256 _tokenId) public {
      ...
      address admin = owner();
      require(ownerofToken == msg.sender || admin == msg.sender, "must be the owner of the token or admin");
      _burn( _tokenId);
    }
